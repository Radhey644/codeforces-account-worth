...
const Main = () => {
  ...
  return (
    ...
    // <CorrectData prblm={prblm}></CorrectData>
  );
...
//     <img src={img} alt="Codeforces account" 
//     className='border-2 w-50% h-50% rounded-2xl object-cover  p-1 relative top-px left-1/2 transform -translate-x-1/2'
//    />
...
//         <h1 class="text-3xl mb-4 font-bold">Cost of Your Codeforces Account</h1>
//         <h1 class="text-5xl font-extrabold text-amber-500">{prblm}$ </h1>
//     </div>
// </div>
